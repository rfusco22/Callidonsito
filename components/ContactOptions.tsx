  ...
  return (
    <div className="bg-primary/10 border-t border-primary/30 px-4 py-4">
      ...
      <div className="grid grid-cols-3 gap-2">
        ...
        {/* WhatsApp Button */}
        <a
          href={`https://wa.me/${config.contact.whatsapp.replace(/\D/g, '')}?text=${encodeURIComponent(`Hi, I'm ${userName || 'a customer'}, I come from ${config.chatbotName}, I'm looking for more information`)}`}
          target="_blank"
